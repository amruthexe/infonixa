...
const Hero = () => {
    return (
        ...
        <p className="max-w-2xl mx-auto mt-2 text-base lg:text-lg text-center text-muted-foreground">
          We build powerful <span className="text-white font-medium">Websites</span>, 
          scalable <span className="text-white font-medium">Mobile Apps</span>, 
          result-driven <span className="text-white font-medium">Digital Marketing</span> campaigns, 
          and intelligent <span className="text-white font-medium">Automation</span> solutions 
